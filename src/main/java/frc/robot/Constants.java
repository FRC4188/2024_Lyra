...
public final class Constants {
  public static final class dashboard {
    /** The time between updates to {@link SmartDashboard}. */
    public static final double REFRESH_PERIOD = 0.1;
  }

  public static final class io {
    /** ID for the pilot controller. */
    public static final int PILOT_CONTROLLER = 0;
    /** ID for the copilot controller. */
  ...
  public static class drivetrain {
    ...
    public static final double BR_ZERO = -144.931640625;
